...
<body style="background-color:#fff">
    ...
    <h2 style="text-align:center">  
        <form method="post" action="../db_connect/connectsql.php">
            ...
            START DATE:<br>
            <input type="text" name="START_DATE" value="" required="required"><br>
            FINSH DATE:<br>
            <input type="text" name="FINSH_DATE" value="" required="required"><br>
            TIME PLANNED:<br>
            <input type="text" name="TIME_PLANNED" value="" required="required"><br><br>
            DESCRIPTION:<br>
